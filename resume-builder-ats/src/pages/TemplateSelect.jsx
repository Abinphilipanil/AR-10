  ...
  return (
    <div className="page" style={{ paddingTop: "100px" }}>
      <div style={{ textAlign: "center", marginBottom: "50px" }}>
        ...
        >
          Every template is rigorously tested for ATS compatibility.
        </p>
                ...
                <div className="template-buttons">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (
                        tName.includes("minimalist") ||
                        tName.includes("simple") ||
                        tName.includes("compact")
                      )
                        format = "Minimalist";
                      else if (
                        tName.includes("creative") ||
                        tName.includes("colorful")
                      )
                        format = "Creative";
                      else if (
                        tName.includes("elegant") ||
                        tName.includes("modern")
                      )
                        format = "Executive";
